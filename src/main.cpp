...
int main() {
    ...
    std::vector<animation::Keyframe> cps = {
        animation::Keyframe{
            sf::seconds(1.f),
            animation::Frame{
    ...
    animation::Animation anim(cps);
    animation::Animation animLin(cps);
    ...
    anim.setInterpolationMethod(animation::KeyframeInterpolationMethod::CatmullRom);
